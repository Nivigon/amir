...
In het menu onder **Levels** staan zes reeksen: Episode Renew, Episode Winter World, Episode Dark Africa, Episode Het Groene Licht (een rustige instap en zeven pittige levels met alle vijanden van het spel en twee panters als eindbaas; begin je bij level 0, dan lees je voor elk level een stukje van het verhaal), Episode De Bron (vijf levels over de droge rivier, met een verhaal en een slot als je bij level 1 begint), en Test levels.
